                ...
                <van-row>
                    ...
                    <van-col span="21">
                        <div class="SupplementaryRecord_list_">
                            ...
                            <p class="SupplementaryRecord_list_img"><span @click="play(item.supple_audio_url)">语音</span><span>({{item.supple_audio_url != '' ? 1 : 0}})</span><span @click="imgPreview(item.supple_path)">照片</span><span>({{item.supple_path.split(',').length}})</span></p>
                        </div>
                    </van-col>
                </van-row>
            </div>
